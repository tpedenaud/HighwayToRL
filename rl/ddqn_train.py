"""
Extension task: Double-DQN vs Standard DQN comparison.

Trains both algorithms on the same benchmark with identical hyperparameters
to measure the effect of Double-DQN's overestimation bias mitigation.
"""
...
def train_dqn_variant(agent_class, seed=0, run_dir=None):
    """
    Universal training function for both DQN and Double-DQN.
    
    Args:
        agent_class: DQN or DoubleDQN class
